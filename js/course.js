...
// ====================================================================
// COURSE PAGE ROUTER
// Maps course IDs to their specific HTML pages
// ====================================================================
function getCoursePageUrl(courseId) {
  // ⭐ ADD YOUR COURSE PAGES HERE
  ...
  // Return the page URL or fallback to dynamic page
  return coursePages[courseId] || `/course-details.html?id=${courseId}`;
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.addEventListener('click', async (e) => {
    if (e.target.classList.contains('view-details-btn')) {
      ...
      // ⭐ Get the correct page URL for this course
      const coursePageUrl = getCoursePageUrl(courseId);
      
      console.log('🔀 Redirecting to:', coursePageUrl);
